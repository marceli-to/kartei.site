...
const props = defineProps({
  ...
  classes: {
    type: String,
    default: 'min-h-default w-full flex items-center justify-center font-muoto-regular text-md text-graphite hover:text-black transition-all cursor-pointer px-8'
  },
  activeClasses: {
    type: String,
